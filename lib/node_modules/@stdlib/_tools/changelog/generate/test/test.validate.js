...
tape( 'the function returns an error if provided a `releaseType` option which is not a string primitive', function test( t ) {
	var values;
	var err;
	var i;
...
tape( 'the function returns an error if provided a `flags` option which is not a string primitive', function test( t ) {
	var values;
	var err;
	var i;
